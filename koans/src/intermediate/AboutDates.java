...
public class AboutDates {
  ...
  public void dateToString() {
    assertEquals(date.toString(), "Sat Mar 03 21:33:21 JST 1973");
  }
  @Koan
  public void changingDateValue() {
    int oneHourInMiliseconds = 3600000;
    date.setTime(date.getTime() + oneHourInMiliseconds);
    assertEquals(date.toString(), "Sat Mar 03 22:33:21 JST 1973");
  }
  @Koan
  public void usingCalendarToChangeDates() {
    ...
    assertEquals(cal.getTime().toString(), "Tue Apr 03 22:33:21 JST 1973");
  }
  @Koan
  public void usingRollToChangeDatesDoesntWrapOtherFields() {
    ...
    assertEquals(cal.getTime().toString(), "Sat Mar 03 22:33:21 JST 1973");
  }
  @Koan
  ...
  public void usingDateFormatToParseDates() throws ParseException {
    ...
    assertEquals(date2.toString(), "Sat Jan 01 00:00:00 JST 2000");
